...
const ARCHITECTURE_RULES = [
  ...
  "Represent a system as an architecture graph: parentId means containment only, while connections represent directed information, control, or dependency flows between nodes.",
  "Add a labeled connection when one architecture part sends data to, invokes, gates, persists for, or renders information from another. Describe direction and payload/action in the label.",
